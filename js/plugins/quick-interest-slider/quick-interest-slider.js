...
function qisCalculate(e) {
	...
	*/
	...
	/*
		Output principal
	*/
	p.find('output').text(rates.currency+principal);
	...
	*/
	...
	form.find('.current_interest').text(rates.currency+Math.floor(interest));
	form.find('.final_total').text(rates.currency+Math.floor(total));
    form.find('.primary_interest').text((rates.currency+Math.floor(primary)));
    form.find('.primary_total').text((rates.currency+Math.floor(primarytotal)));
    form.find('.secondary_interest').text((rates.currency+Math.floor(secondary)));
    form.find('.secondary_total').text((rates.currency+Math.floor(secondarytotal)));
    form.find('.repayment').text((rates.currency+Math.floor(repayment)));
}
